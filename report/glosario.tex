...
\newglossaryentry{grc}{
    ...
    description={Interfaz gráfica para el desarrollo y ejecución de aplicaciones de \gls{gnuradio}.}
}
...
\newglossaryentry{skyfield}{
        name={Skyfield},
        description={Biblioteca de Python para cálculos astronómicos de alta precisión, incluyendo propagación orbital, transformaciones de marcos de referencia y correcciones como el efecto \gls{efectodoppler}.}
}
...
\newglossaryentry{afsk}{
        name={AFSK},
        description={Modulación por desplazamiento de frecuencia de audio (\textit{Audio Frequency Shift Keying}). Técnica de modulación digital donde los datos binarios se representan mediante dos frecuencias de audio distintas, comúnmente utilizada en comunicaciones satelitales de radioaficionados.}
}

% Centro de control
\newglossaryentry{centrocontrol}{
        name={centro de control de misión},
        description={Instalación que administra y monitorea una misión espacial, utilizando funciones de \gls{telemetriaseguimientoycontrol}.}
}