...
El protocolo \gls{HDLC} (High-Level Data Link Control) es un protocolo de capa de enlace de datos ampliamente utilizado en comunicaciones satelitales, especialmente en misiones de órbita baja y proyectos de \gls{cubesat}. Constituye el estándar de facto para el intercambio de información entre estaciones terrenas y satélites de radioaficionados debido a su robustez, eficiencia y capacidad de operar en entornos con alta tasa de errores.
...
\hline
\end{tabular}
\caption{Estructura del frame \gls{HDLC}}
