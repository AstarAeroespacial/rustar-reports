...
\textit{Protocolo de comunicación, (de)framing, (de)modulación:} Se evaluarían librerías open source en Rust para el protocolo AX.25 o \gls{HDLC} y la etapa de (de)modulación con \gls{afsk}. Se utiliza esta combinación de modulación \gls{afsk} con framing AX.25 o \gls{HDLC} por ser la más común en satélites amateur.
...
\textit{Tracking:} Ya está casi terminado, muy parecido a \gls{gpredict}.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Estación terrena: descripción general (partes, responsabilidades, scheduler). Tracking, Mod/demod (\gls{gnuradio}, \gls{afsk}1200), Framing/deframing (\gls{HDLC}), SDR, antenna controller.
  ...
  \item Para la sección ``Experimentación y validación'': visitas al LABi, pruebas con antena, simulación con \gls{gnuradio}.
