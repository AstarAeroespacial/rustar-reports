...
Un mensaje importante es la actualización del \gls{tle} a seguir, ya que esto afecta tanto al trackeo (para el módulo de control de la antena) como a la (de)modulación (por la corrección por \hyperref[gls:efectodoppler]{Doppler}).
