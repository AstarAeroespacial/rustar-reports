...
\begin{itemize}
  ...
  \item Aprendizaje de GNU Radio para el procesamiento de señales.
  \item Investigación sobre propagación orbital y el modelo SGP4.
  \item Experimentación inicial en el LABi con SDR.
...
\begin{itemize}
  \item \textbf{Tracking:} cálculo de posición, acimut, elevación y corrección Doppler.
  \item \textbf{Modulación y demodulación:} integración con GNU Radio para el procesamiento de señales.
...
\subsubsection{Demostración a Astar Aeroespacial (7 de septiembre)}
...
\begin{enumerate}
  \item \textbf{Integración gs + GNU Radio:} validación del procesamiento de señales y la demodulación de datos mediante flujos simulados.
...
\begin{enumerate}
  \item \textbf{Pruebas con SDR:} recepción de señales reales utilizando dispositivos SDR y validación del procesamiento de señales.
