...
\begin{itemize}
  ...
  \item Investigación sobre propagación orbital y el modelo \gls{sgp4}.
...
\begin{itemize}
  ...
  \item \textbf{Comunicación \gls{mqtt}:} publicación y suscripción a topics para intercambio de datos.
\end{itemize}
...
\begin{itemize}
  ...
  \item Coordinación entre múltiples componentes del sistema mediante \gls{mqtt}.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Integración gs + backend:} verificación del intercambio de mensajes y la correcta publicación/suscripción a tópicos \gls{mqtt}.
