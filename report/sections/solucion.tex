...
La estación terrena es el componente encargado de establecer y mantener la comunicación directa con el satélite, tanto en downlink como en uplink. La aplicación que la controla se despliega físicamente junto a la antena, posiblemente en sitios remotos o con conectividad limitada, lo que demanda un diseño autónomo, confiable y eficiente en cuanto a la gestión de recursos.

El centro de control de misión concentra las funciones de supervisión, planificación y operación. Está compuesto por un servidor que gestiona la comunicación con las estaciones terrena. Incluye una base de datos para persistir información y parámetros de la misión. También incluye una interfaz gráfica que ofrece a los operadores una visión integrada del estado en tiempo real de las estaciones y satélites, visualización de la telemetría recibida y herramientas para planificar observaciones y enviar telecomandos a los satélites.
