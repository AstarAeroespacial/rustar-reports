...
\begin{itemize}
    ...
    \item \textbf{Lenguajes de programación:} Rust en su mayoría, con integración de Python para scripts específicos y bindings con \gls{gnuradio}.
    ...
    \item \textbf{Procesamiento de señales:} \gls{gnuradio} (integración mediante bindings)
\end{itemize}
