...
\begin{itemize}
    \item En una computadora se ejecutó la aplicación de estación terrena en modo transmisión, generando frames HDLC, aplicando el esquema de modulación y enviando las muestras al \gls{SDR} transmisor.
