...
\begin{itemize}
    \item \textbf{Configuración de parámetros \gls{SDR}}: verificación de que la aplicación de estación terrena podía configurar correctamente frecuencia, tasa de muestreo y ganancia de los dispositivos mediante \gls{soapysdr}.
