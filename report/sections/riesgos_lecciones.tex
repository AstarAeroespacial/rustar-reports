...
\begin{itemize}
  \item Mecánica orbital y modelos de propagación (SGP4/SDP4)
  ...
  \item Manejo de hardware \gls{SDR} y procesamiento en GNU Radio
\end{itemize}
...
Si bien se había identificado como riesgo la limitación de bibliotecas nativas de procesamiento de señales en Rust, la materialización de este riesgo tomó una forma diferente a la prevista. En lugar de desarrollar bindings propios o usar FFI directamente desde Rust, la solución adoptada fue integrar con GNU Radio como componente externo del sistema.
...
\begin{itemize}
  ...
  \item Debugging de problemas que involucraban múltiples tecnologías (Rust, Python, GNU Radio)
