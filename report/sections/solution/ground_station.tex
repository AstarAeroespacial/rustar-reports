...
\begin{itemize}
    ...
    \item La corrección de frecuencia por efecto Doppler, tanto para la transmisión (\textit{uplink}) como para la recepción (\textit{downlink}), compensando el desplazamiento de frecuencia causado por el movimiento relativo entre la estación y el satélite.
\end{itemize}
